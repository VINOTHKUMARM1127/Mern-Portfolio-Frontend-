...
const Skils = () => {
  ...
  const skeleton = () => {
    return (
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-5 px-10 md:px-5 animate-pulse">
        {Array.from({ length: 6 }).map((sk) => (
          <div className="rounded-md px-8 sm:px-16 py-5 bg-gray-600 w-full h-3 mb-3 opacity-60 gap-2"></div>
        ))}
      </div>
    );
  };
      ...
      <div className="flex justify-center md:justify-evenly text-center flex-col lg:flex-row">
        <section className="border border-[#b14fc4] bg-[#171721] rounded-xl px-0 mx-[10%] my-5 md:px-1 pb-8 lg:mx-0 lg:my-0 opacity-80 shadow-[0_0_10px_#d607ed]">
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-5 px-10 md:px-5">
              {data
